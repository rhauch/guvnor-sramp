 ...
 *       &lt;sequence>
 *         &lt;element name="importedXsds" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="includedXsds" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="redefinedXsds" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="importedWsdls" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
    ...
    implements Serializable
{
    ...
    protected List<Target> importedWsdls;
    @XmlAttribute
    ...
    public List<Target> getImportedXsds() {
        if (importedXsds == null) {
            importedXsds = new ArrayList<Target>();
        }
    ...
    public List<Target> getIncludedXsds() {
        if (includedXsds == null) {
            includedXsds = new ArrayList<Target>();
        }
    ...
    public List<Target> getRedefinedXsds() {
        if (redefinedXsds == null) {
            redefinedXsds = new ArrayList<Target>();
        }
     ...
     * 
     */
    public List<Target> getImportedWsdls() {
        if (importedWsdls == null) {
            importedWsdls = new ArrayList<Target>();
        }
