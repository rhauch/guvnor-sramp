 ...
 *       &lt;sequence>
 *         &lt;element name="operation" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;anyAttribute/>
 *     &lt;/extension>
 *   &lt;/complexContent>
    ...
    implements Serializable
{
    ...
    private static final long serialVersionUID = 7399211850499890753L;
    protected List<Target> operation;
     ...
     * 
     */
    public List<Target> getOperation() {
        if (operation == null) {
            operation = new ArrayList<Target>();
        }
