 ...
 *       &lt;sequence>
 *         &lt;element name="involvesParty" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="specifies" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *       &lt;anyAttribute/>
 *     &lt;/extension>
 *   &lt;/complexContent>
    ...
    implements Serializable
{
    ...
    protected List<Target> involvesParty;
    @XmlElement(required = true)
    protected List<Target> specifies;
     ...
     * 
     */
    public List<Target> getInvolvesParty() {
        if (involvesParty == null) {
            involvesParty = new ArrayList<Target>();
        }
     ...
     * 
     */
    public List<Target> getSpecifies() {
        if (specifies == null) {
            specifies = new ArrayList<Target>();
        }
