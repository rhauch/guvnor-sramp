 ...
 *       &lt;sequence>
 *         &lt;element name="provides" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    private static final long serialVersionUID = 1972445253451428153L;
    protected List<Target> provides;
     ...
     * 
     */
    public List<Target> getProvides() {
        if (provides == null) {
            provides = new ArrayList<Target>();
        }
