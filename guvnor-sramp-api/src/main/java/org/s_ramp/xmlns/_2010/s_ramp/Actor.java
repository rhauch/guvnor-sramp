 ...
 *       &lt;sequence>
 *         &lt;element name="does" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="setsPolicy" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;anyAttribute/>
 *     &lt;/extension>
 *   &lt;/complexContent>
    ...
    implements Serializable
{
    ...
    private static final long serialVersionUID = -2834488167970947778L;
    protected List<Target> does;
    protected List<Target> setsPolicy;
     ...
     * 
     */
    public List<Target> getDoes() {
        if (does == null) {
            does = new ArrayList<Target>();
        }
        return this.does;
    }
     ...
     * 
     */
    public List<Target> getSetsPolicy() {
        if (setsPolicy == null) {
            setsPolicy = new ArrayList<Target>();
        }
