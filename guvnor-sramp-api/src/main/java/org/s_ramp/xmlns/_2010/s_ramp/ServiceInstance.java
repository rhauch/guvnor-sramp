 ...
 *         &lt;element name="describedBy" type="{http://s-ramp.org/xmlns/2010/s-ramp}target" maxOccurs="unbounded" minOccurs="0"/>
    ...
    implements Serializable
{
    ...
    private static final long serialVersionUID = -772518403845563606L;
    protected List<Target> uses;
    protected List<Target> describedBy;
     ...
     * 
     */
    public List<Target> getDescribedBy() {
        if (describedBy == null) {
            describedBy = new ArrayList<Target>();
        }
